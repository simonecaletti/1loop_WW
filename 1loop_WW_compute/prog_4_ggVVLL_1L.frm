...
* 1) Compute the helicity coefficients for LL configuration
...
#include ../Tensor_decomposition/projectorscoeffs.inc
    .sort
#include ../Tensor_decomposition/helicity_coeff_LL.inc
id 1/(?x) = Den(?x);
.sort
*#include ../Tensor_decomposition/LLggVV_alt.inc
*.sort
...
#do i=1,18
#write <Helicity_form_factors/He'i'LL.inc> "g He'i' = %E ; " [He'i']
#enddo
...
#do i=1,18
format mathematica;
#write <../Numerical_Evaluation_1loop/gg1l_results_AG/He'i'_LL.m> "HeLL['i'] = ( %E ) ; " [He'i'] ;
#write <../Numerical_Evaluation_1loop/gg1l_results_AG/He'i'_LL.m> "" ;
format normal;
#enddo
print+s;
    .end
