...
#do i=1,36
#write <Form_factors/FF'i'.inc> "g F'i' = %E ; " [F'i']
#enddo
...
#do i=1,36
format mathematica;
#write <../Numerical_Evaluation_1loop/gg1l_results_AG/FF'i'.m> "F['i'] = ( %E ) ; " [F'i'] ;
#write <../Numerical_Evaluation_1loop/gg1l_results_AG/FF'i'.m> "" ;
format normal;
#enddo
print+s;
    .end
